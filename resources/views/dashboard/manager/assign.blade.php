                ...
                <div class="card xl:col-span-2">
                        <div class="card-body flex flex-col p-6">
                            <header class="flex mb-5 items-center border-b border-slate-100 dark:border-slate-700 pb-5 -mx-6 px-6">
                                <div class="flex-1">
                                    <div class="card-title text-slate-900 dark:text-white">Assign Technician</div>
                                </div>
                            </header>
                            <div class="card-text h-full ">
                                <form class="space-y-4" method="post" action="{{route('manager.assignCheckIn')}}">
                                    @csrf
                                    ...
                                    <!-- </div> -->
                                    <button type="submit" class="btn inline-flex justify-center btn-dark">Assign</button>
                                </form>
                            </div>
                        </div>
                    </div>
