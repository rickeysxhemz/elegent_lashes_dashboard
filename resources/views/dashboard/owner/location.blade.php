                  ...
                  <div class="card xl:col-span-2 rounded-md bg-white dark:bg-slate-800 lg:h-full shadow-base">
                      <div class="card-body p-6">
                        <header class="flex mb-5 items-center border-b border-slate-100 dark:border-slate-700 pb-5 -mx-6 px-6">
                          <div class="flex-1">
                            <div class="card-title text-slate-900 dark:text-white">Manage Locations</div>
                          </div>
                          <div>
                        <a href="{{route('owner.createLocationPage')}}">
                          ...
                          <div class="overflow-x-auto -mx-6">
                           ...
                           <tr>
                                ...
                                <tr>
                                      ...
                                      <!-- <td class="table-td">{{$location->Address ?? 'Not assigned'}}</td>
                                      <td class="table-td">{{$location->city ?? 'Not assigned'}}</td> 
                                     
                                      <td class="table-td">{{$location->state ?? 'Not assigned'}}</td> -->
                                      <td class="table-td">
                                        <div class="relative">
                                  ...
                                  <a href="{{route('owner.deleteLocation',$location->id)}}">
