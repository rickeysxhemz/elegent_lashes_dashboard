                      ...
                      <div class="overflow-x-auto -mx-6 dashcode-data-table">
                        ...
                        <div class="inline-block min-w-full align-middle">
                          ...
                          <span class="w-7 h-7 rounded-full ltr:mr-3 rtl:ml-3 flex-none">
                            <img src="{{asset('dashboard/assets/images/all-img/customer_1.png')}}" alt="3" class="object-cover w-full h-full rounded-full">
                          </span>
                                    <span class="text-sm text-slate-600 dark:text-slate-300 capitalize">{{$transaction->client->first_name ?? N/A}}</span>
                                    </span>
                                  </td>
