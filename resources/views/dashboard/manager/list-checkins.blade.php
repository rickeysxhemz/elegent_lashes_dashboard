                  ...
                  <div class="card xl:col-span-2 rounded-md bg-white dark:bg-slate-800 lg:h-full shadow-base">
                      <div class="card-body p-6">
                        <header class="flex mb-5 items-center border-b border-slate-100 dark:border-slate-700 pb-5 -mx-6 px-6">
                          <div class="flex-1">
                            <div class="card-title text-slate-900 dark:text-white">JOBS DONE</div>
                          </div>
                                ...
                                <table class="min-w-full divide-y divide-slate-100 table-fixed dark:divide-slate-700">
                                  ...
                                  @foreach($check_ins as $check_in)
                                    <tr>
                                     ...
                                     <td class="table-td">{{$check_in->transaction->service->name}}</td>
                                    ...
                                    <span class="flex items-center">
                                        <span>PAYMENT VERIFIED BY TECHNICIAN</span>
                                    </span>
                                  </button>
