                      ...
                      <div class="card-body">
                        ...
                        @if(isset($totalPaymentCalculated))
                         <header class="border-b px-4 pt-4 pb-3 flex items-center border-success-500">
                            ...
                            <h3 class="card-title mb-0 text-success-500">Calculation
                            &nbsp${{$totalPaymentCalculated}}</h3>
                          </header>
                          @else
                         <header class="border-b px-4 pt-4 pb-3 flex items-center border-success-500">
                            <iconify-icon class="text-3xl inline-block ltr:mr-2 rtl:ml-2 text-success-500" icon="ph:circle-wavy-check"></iconify-icon>
                            <h3 class="card-title mb-0 text-success-500">Earning
                            &nbsp${{$totalPayment}}</h3>
                          </header>
                          @endif
                          <div class="py-3 px-5">
                            <h5 class="card-subtitle">Monthly Total Earning</h5>
                            <p class="card-text mt-3">The above is total earning including tips to filter by month use below calculator</p>
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="card-text h-full ">
                                <form class="space-y-4" method="post" action="{{ route('owner.revenueCalculate') }}">
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-7">
                                        ...
                                        <div>
                                          <label for="humanFriendly_picker" class="form-label">Single Day</label>
                                          <input class="form-control @error('start_date') border-red-500 @enderror py-2 flatpickr flatpickr-input active" id="start_date_picker" name="start_date" type="text" readonly="readonly">
                                          @error('start_date')
                                                <span class="text-red-500 text-sm">{{ $message }}</span>
                                            @enderror
