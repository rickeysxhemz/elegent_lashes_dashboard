                  ...
                  <div class="card xl:col-span-2 rounded-md bg-white dark:bg-slate-800 lg:h-full shadow-base">
                      <div class="card-body p-6">
                        <header class="flex mb-5 items-center border-b border-slate-100 dark:border-slate-700 pb-5 -mx-6 px-6">
                          <div class="flex-1">
                            <div class="card-title text-slate-900 dark:text-white">Manage CheckIn</div>
                          </div>
                          <div>
                          ...
                          <div class="overflow-x-auto -mx-6">
                           ...
                           <tr>
                                ...
                                <tr>
                                     ...
                                     <a href="{{route('owner.updateClientPage',$client->id)}}" class="mr-2">                                       
                                  ...
                                  <a href="{{route('owner.listCheckinsByUser',$client->id)}}"  class="mr-2">
                                  <button class="btn inline-flex justify-center btn-secondary btn-sm" >
                                    <span class="flex items-center">
                                        <span>Expand</span>
                                    </span>
                                  ...
                                  <a href="{{route('owner.deleteLocation',$client->id)}}">
