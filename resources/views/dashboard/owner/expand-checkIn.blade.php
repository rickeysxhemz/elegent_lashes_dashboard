                  ...
                  <div class="card xl:col-span-2 rounded-md bg-white dark:bg-slate-800 lg:h-full shadow-base">
                      <div class="card-body p-6">
                        <header class="flex mb-5 items-center border-b border-slate-100 dark:border-slate-700 pb-5 -mx-6 px-6">
                          <div class="flex-1">
                            <div class="card-title text-slate-900 dark:text-white">All checkIns</div>
                          </div>
                          <div>
                         <a href="{{route('owner.listCheckins')}}">
                                        ...
                                        <div class="flex items-center">
                                          ...
                                          <div class="flex-1 text-start">
                                            <h4 class="text-sm font-medium text-slate-600 whitespace-nowrap">
                                             {{$checkin->client->first_name}}
                                            </h4>
                                          </div>
                                        </div>
                                      </td>
                                      <td class="table-td">{{$checkin->client->last_name}}</td>
                                      <td class="table-td">{{$checkin->client->phone}}</td> 
                                      
                                      <td class="table-td">{{$checkin->location->name}}</td> 
                                      <td class="table-td">
                                        <div class="relative">
